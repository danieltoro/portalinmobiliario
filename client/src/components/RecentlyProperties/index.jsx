          ...
          <div className="row">
            <div className="carousel our-partners slide" id="ourPartners2">
              <div className="col-lg-12 mrg-btm-30">
                <a className="right carousel-control" href="index.html#ourPartners2" data-slide="prev">
                  <i className="fa fa-chevron-left icon-prev"></i>
                </a>
                <a className="right carousel-control" href="index.html#ourPartners2" data-slide="next">
